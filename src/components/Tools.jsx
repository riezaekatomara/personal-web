...
function Tools() {
  ...
  const getParallaxStyle = (index) => ({
    transform: `translate(${
      mousePosition.x * 0.01 * (index % 2 === 0 ? 1 : -1)
    }px, ${mousePosition.y * 0.01 * (index % 3 === 0 ? 1 : -1)}px)`,
  });
  ...
  return (
    <div className="tools py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        {/* Tools Grid */}
        <div className="tools-box max-w-7xl mx-auto grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6">
          {listTools.map((tool, index) => (
            ...
            >
              ...
              {/* Main Card */}
              <div className="relative bg-gradient-to-br from-white/5 to-white/2 backdrop-blur-sm border border-white/10 rounded-2xl p-6 overflow-hidden group-hover:border-white/20 transition-all duration-500 transform group-hover:-translate-y-2">
                {/* Decorative Corner */}
